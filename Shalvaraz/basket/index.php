		...
		<div id="right"><div id="rgtop">
			<?php 
				if(@$_SESSION["ad"]){
					...
					<img alt='img' style="cursor:pointer;" onclick="location.href='./'" src='../img/Group 10.svg'><?php
					if(!empty($_SESSION["sebetsayi"])){
						?><span style="cursor:pointer;font-weight:bold;" onclick="location.href='./'"><?php echo $_SESSION["sebetsayi"];?></span><?php
					}else{
						?><span style="cursor:pointer;font-weight:bold;" onclick="location.href='./'">0</span><?php
					}
				}else{
...
<div id="main">		
	<div id="add">
		<?php 
			...
			?><img alt="img" src="../img/plus.svg" onclick="location.href='../add/'"><?php
	...
	<div id="footer">
		...
		<div class="footerbtm4">
			<div id="ftleft"><a>AZƏRBAYCAN</a><br><h5 onclick='location.href="../"'>ADELDO STORE</h5><h4>/</h4><h5  onclick='location.href="../"'>QADIN</h5><h4>/</h4><h5  onclick='location.href="../"' >KİSİ</h5><h4>/</h4><h5  onclick='location.href="../"' >USAQ</h5><h4>/</h4><h5  onclick='location.href="../"' >ENDİRİMLER</h5></div>
