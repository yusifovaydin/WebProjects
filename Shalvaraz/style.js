...
pres.addEventListener('click',function(){
	...
	var menyubtn = document.querySelector("#buttonmenyu");
	var clsmenyu = document.querySelector("#clsmenyu");
	var menyu  = document.querySelector("#openmenyu");
	

	menyubtn.addEventListener("click",function(){
		menyu.style.left="0";
	});
...
function grid(){
	iki.addEventListener('click',function(){
		row.style.gridTemplateColumns = "49% 49%";		
	});	
	dord.addEventListener('click',function(){
		row.style.gridTemplateColumns = "23.31% 23.31% 23.31% 23.31%";
	});	
}
